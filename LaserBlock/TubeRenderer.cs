...
namespace ImprovedLaserBlock
{
    public class CustomTubeRenderer : MonoBehaviour
    {
        ...
        */
        ...
        // Script was modified slightly to allow it to work properly as part of a Besiege mod.
        ...
        public void Reset()
        {
            ...
            new TubeVertex(transform.forward * 5f, 1.0f, Color.white),
            };
        }
        public void Start()
        {
        ...
        private static Vector3[] InvTransformPoints(Vector3[] points, Transform t)
        {
            Vector3[] v = new Vector3[points.Length];
            for (int i = 0; i < points.Length; i++)
            {
                v[i] = t.InverseTransformPoint(points[i]);
            }
            return v;
        }
    }
